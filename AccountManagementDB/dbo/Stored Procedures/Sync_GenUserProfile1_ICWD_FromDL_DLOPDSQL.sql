...
-- =============================================
CREATE PROCEDURE [dbo].[Sync_GenUserProfile1_ICWD_FromDL_DLOPDSQL]
AS
BEGIN
...
where isSuccess=1 and chProcessHosp='DL' and nvProcessJob like '同步%'
...
from DLOPDSQL.DB_GEN.dbo.GenUserProfile1_ICWD
...
begin
	...
	update DLOPDSQL.DB_GEN.dbo.GenUserProfile1_ICWD

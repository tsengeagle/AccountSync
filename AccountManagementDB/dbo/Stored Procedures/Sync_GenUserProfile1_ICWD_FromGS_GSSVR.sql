...
-- =============================================
CREATE PROCEDURE [dbo].[Sync_GenUserProfile1_ICWD_FromGS_GSSVR]
AS
BEGIN
...
where isSuccess=1 and chProcessHosp='GS' and nvProcessJob like '同步%'
...
from GSSVR.DB_GEN.dbo.GenUserProfile1_ICWD
...
begin
	...
	update GSSVR.DB_GEN.dbo.GenUserProfile1_ICWD

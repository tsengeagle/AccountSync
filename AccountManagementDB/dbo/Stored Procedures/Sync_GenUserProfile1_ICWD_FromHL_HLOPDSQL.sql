...
-- =============================================
CREATE PROCEDURE [dbo].[Sync_GenUserProfile1_ICWD_FromHL_HLOPDSQL]
AS
BEGIN
...
where isSuccess=1 and chProcessHosp='HL' and nvProcessJob like '同步%'
...
from HLOPDSQL.DB_GEN.dbo.GenUserProfile1_ICWD
...
begin
	...
	update HLOPDSQL.DB_GEN.dbo.GenUserProfile1_ICWD

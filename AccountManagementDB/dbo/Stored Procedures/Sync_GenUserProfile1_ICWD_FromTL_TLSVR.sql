...
-- =============================================
CREATE PROCEDURE [dbo].[Sync_GenUserProfile1_ICWD_FromTL_TLSVR]
AS
BEGIN
...
where isSuccess=1 and chProcessHosp='TL' and nvProcessJob like '同步%'
...
from TLSVR.DB_GEN.dbo.GenUserProfile1_ICWD
...
begin
	...
	update TLSVR.DB_GEN.dbo.GenUserProfile1_ICWD

...
-- =============================================
CREATE PROCEDURE [dbo].[Sync_GenUserProfile1_ICWD_FromUL_ULSVR]
AS
BEGIN
...
where isSuccess=1 and chProcessHosp='UL' and nvProcessJob like '同步%'
...
from ULSVR.DB_GEN.dbo.GenUserProfile1_ICWD

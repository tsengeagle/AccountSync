...
-- =============================================
CREATE PROCEDURE [dbo].[Sync_GenUserProfile1_ICWD_FromXD_OPDSQL1]
AS
BEGIN
...
where isSuccess=1 and chProcessHosp='XD' and nvProcessJob like '同步%'
...
from OPDSQL1.DB_GEN.dbo.GenUserProfile1_ICWD
...
begin
	...
	update OPDSQL1.DB_GEN.dbo.GenUserProfile1_ICWD
